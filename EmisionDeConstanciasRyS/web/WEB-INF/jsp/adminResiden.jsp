                    ...
                    <c:if test = "${tamTra>=0}">
                        <c:forEach var = "i" begin = "0" end = "${tamTra}">
                            <tr>                    
                                ...
                                <td>
                                    <a href="editarTramiteR.htm?id=${tmp[i].idtramites}" arget="contenedorIFrame" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                    <a href="borrarR.htm?id=${tmp[i].idtramites}"class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </c:if>
